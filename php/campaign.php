<? include "include/header.php" ?>
	...
	<link rel="stylesheet" href="flexslider/cp-flexslider.css">
	<link rel="stylesheet" href="flexslider/cp-fs-slide.css">
	<link rel="stylesheet" href="css/campaign.css">
	<link href="aos-master/aos.css" rel="stylesheet">
	<script src="flexslider/jquery.flexslider.js"></script>
	<script src="scrollout-splitting/splitting.js"></script>
	<script src="scrollout-splitting/scroll-out.min.js"></script>
	<script src="aos-master/aos.js"></script>
	<script>
		$(function() {
	...
	<section>
		...
		<div class="cp-wrap">
			<div class="cp-safe-video">
				<video src="video/cp-safe-video.mp4" controls loop autoplay muted >
			</div>
